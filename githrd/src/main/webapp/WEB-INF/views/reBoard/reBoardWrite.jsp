...
<c:if test="${not empty SID}">
			...
			<div class="w3-col w3-round-large w3-card-4 w3-margin-bottom w3-padding">
				...
				<div class="w3-rest w3-padding">
					...
					<form method="POST" action="/www/reBoard/writeProc.blp"
						...
						<input type="hidden" id="id" name="mno" value="${DATA.id}">
						<textarea class="w3-col w3-padding w3-border ft12" id="body" name="body"
		...
		<div class="w3-col w3-margin-top w3-card-4">
			<div class="w3-third w3-button w3-green" id="listbtn">list</div>
