...
<div class="w3-bar w3-white w3-large">
  <a class="w3-bar-item w3-button w3-red w3-mobile"><i class="fa fa-bed w3-margin-right"></i>Home</a>
  <a class="w3-bar-item w3-button w3-mobile">회 원</a>
  <a class="w3-bar-item w3-button w3-mobile">방명록</a>
  <a class="w3-bar-item w3-button w3-mobile">댓글게시판</a>
  <a class="w3-bar-item w3-button w3-mobile">게 시 판</a>
  <a class="w3-bar-item w3-button w3-right w3-light-grey w3-mobile">설문조사</a>
</div>
<!-- Header -->
<header class="w3-display-container w3-content" style="max-width:1500px;">
  <div class="w3-image" style="min-width:1000px; width: 1500px; height: 800px; overflow: hidden; position: relative; top: -100px; z-index: -1;">
  	<img class="w3-image" src="/www/img/jennie02.jpg" alt="The Hotel" style="min-width:1000px" width="1500" height="auto">
  </div>
  <div class="w3-display-middle w3-padding w3-col l6 m8">
    <div class="w3-col w3-card-4">
	    <div class="w3-container w3-blue">
	      <h2><i class="fa fa-users w3-margin-right"></i>LOGIN</h2>
	    </div>
	    <div class="w3-container w3-white w3-padding-16">
	      <form action="/action_page.php" target="_blank">
	        <div class="w3-row-padding" style="margin:0 -16px;">
	          <div class="w3-col w3-margin-bottom">
	            <label><i class="fa fa-user"></i> <span style="position: relative; left: 10px;">I D </span></label>
	            <input class="w3-input w3-border" type="text" placeholder="아이디를 입력하세요!" name="id" required>
	          </div>
	          <div class="w3-col w3-margin-bottom">
	            <label><i class="fa fa-key"></i> <span style="position: relative; left: 10px;">P W </span></label>
	            <input class="w3-input w3-border" type="password" placeholder="비밀번호를 입력하세요!" name="pw" required>
	          </div>
	        </div>
	        <button class="w3-button w3-green" type="button"><i class="fa fa-close w3-margin-right"></i> Close</button>
	        <button class="w3-right w3-button w3-indigo" type="button"><i class="fa fa-key w3-margin-right"></i> Login</button>
	      </form>
	    </div>
  	</div>
  </div>
